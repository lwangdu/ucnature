 ...
 * Slug: ucnature/footer-three-columns-contrast-background
 * Categories: footer
...
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Privacy Policy', 'ucnature' ); ?> · <?php echo esc_html__( 'Terms of Service', 'ucnature' ); ?> · <?php echo esc_html__( 'Contact Us', 'ucnature' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Facebook', 'ucnature' ); ?> · <?php echo esc_html__( 'Instagram', 'ucnature' ); ?> · <?php echo esc_html__( 'Twitter', 'ucnature' ); ?></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
