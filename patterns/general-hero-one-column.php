...
<p class="has-text-align-center"><?php echo esc_html__( 'Highlight research, teaching, stewardship, and field experiences across the UC Natural Reserve System with a flexible page layout.', 'ucnature' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
