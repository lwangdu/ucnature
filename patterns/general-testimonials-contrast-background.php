 ...
 * Slug: ucnature/general-testimonials-contrast-background
...
<p class="has-text-align-center" style="margin-top:0px"><?php echo esc_html__( 'Adapt this testimonial layout with quotes from researchers, educators, partners, or supporters.', 'ucnature' ); ?></p>
<!-- /wp:paragraph -->
