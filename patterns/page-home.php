...
<h2 class="wp-block-heading has-text-align-center has-max-72-font-size" style="margin-bottom:0px;letter-spacing:-1px"><?php echo esc_html__( 'Explore California through the UC Natural Reserve System.', 'ucnature' ); ?></h2>
...
<div class="wp-block-group"><!-- wp:heading {"anchor":"intro-text-on-left-image-on-right","className":"wp-block-heading","fontSize":"max-36"} -->
<h2 class="wp-block-heading has-max-36-font-size" id="intro-text-on-left-image-on-right"><?php echo esc_html__( 'Built for the UC Natural Reserve System', 'ucnature' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<div class="wp-block-group" style="padding-bottom:var(--wp--preset--spacing--large)"><!-- wp:heading {"textAlign":"center","anchor":"features-intro","style":{"typography":{"letterSpacing":"-1px"}},"className":"wp-block-heading","fontSize":"max-60"} -->
<h2 class="wp-block-heading has-text-align-center has-max-60-font-size" id="features-intro" style="letter-spacing:-1px"><?php echo esc_html__( 'Flexible patterns for mission-driven storytelling.', 'ucnature' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"typography":{"lineHeight":"1.5"}}} -->
<p class="has-text-align-center" style="line-height:1.5"><?php echo esc_html__( 'Use these sections as a starting point for reserve profiles, news highlights, calls to action, and visitor information.', 'ucnature' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading has-x-large-font-size"><?php echo esc_html__( 'Patterns ready for reserve stories', 'ucnature' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"fontSize":"x-large"} -->
<h2 class="wp-block-heading has-x-large-font-size"><?php echo esc_html__( 'One system, many stories', 'ucnature' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<!-- wp:column {"verticalAlignment":"center"} -->
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"fontSize":"x-large"} -->
<h2 class="wp-block-heading has-x-large-font-size"><?php echo esc_html__( 'Designed for clear communication', 'ucnature' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
